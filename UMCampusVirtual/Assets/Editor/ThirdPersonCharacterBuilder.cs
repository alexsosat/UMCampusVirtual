...
{
    private const string AnimatorPath = "Assets/Character/ThirdPersonController/Character/Animations/StarterAssetsThirdPerson.controller";
    private const string InputAssetPath = "Assets/Character/InputSystem/StarterAssets.inputactions";
